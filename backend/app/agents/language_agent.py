...
class LLMAgent(Agent):
    ...
    async def ask(self, user_query: str, conversation_id: str, call_sid: Optional[str] =  None) -> str:
        response = await self.agent.ainvoke(
            input={"messages": [HumanMessage(content=user_query)]},
            config={"configurable": {"thread_id": conversation_id, "call_sid": call_sid}},
    ...
    async def adebug_ask(self, messages: list, conversation_id: str) -> List[BaseMessage]:
